                                    ...
                                    ?>
                                        <form class="row g-3" method="POST" action="">
                                            ...
                                            <div class="col-12 col-sm-6 col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="first-name" name="first-name" placeholder="<?php echo $row['first_name']; ?>" />
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-6 col-md-3">
                                                ...
                                                <input type="text" class="form-control" id="forth-name" name="forth-name" placeholder="<?php echo $row['third_name']; ?>" readonly />
                                            </div>
                                            <div class="col-12 col-sm-6 col-md-3">
                                                <label for="fourth-name" class="form-label">اللقب<span class="redStar">*</span></label>
                                                <input type="text" class="form-control" id="fourth-name" name="sure_name" />
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-select" aria-label="Default select example" name="nationalism" id="nationalism">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-select" aria-label="Default select example" name="gender" id="sex">
                                                    <option disabled selected>اختر</option>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-3 div1 ">
                                                ...
                                                <input type="number" class="form-control" id="fam-number" name="fam-number" />
                                            </div>
                                            <div class="col-12 col-lg-6 col-xl-4 div9 ">
                                                <label class="form-label">تاريخ إصدار البطاقة الوطنية<span class="redStar">*</span></label>
                                                <div class="row">
                                                    <div class="col-12 col-sm-4">
                                                        <select id="id-cardday" name="id-cardday" class="form-select">
                                                    ...
                                                    <div class="col-12 col-sm-4">
                                                        <select id="id-cardyear" name="id-cardyear" class="form-select">
                                            ...
                                            <div class="col-12 col-md-6 col-xl-4 div3 ">
                                                ...
                                                <select class="form-select" aria-label="Default select example" id="id-province1" name="id-province2">
                                                    <option disabled selected>اختر</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="ol-12 col-md-6 col-xl-4 div5 ">
                                                ...
                                                <input type="number" class="form-control" id="id-history-number" name="id-history-number" />
                                            </div>
                                            <div class="ol-12 col-md-6 col-xl-4 div6 ">
                                                <label for="id-newspaper-number" class="form-label">رقم صحيفة هوية الاحوال
                                                    المدنية<span class="redStar">*</span></label>
                                                <input type="number" class="form-control" id="id-newspaper-number" name="id-newspaper-number" />
                                            </div>
                                            ...
                                            <div class="col-12 col-lg-6 col-xl-4 div8 ">
                                                ...
                                                <input type="number" class="form-control" id="id-certificate-number" name="id-certificate-number" />
                                            </div>
                                            <div class="col-12 col-md-6 col-lg-6 col-xl-5">
                                                <label for="martial-status" class="form-label">الحالة الاجتماعية<span class="redStar">*</span></label>
                                                <select class="form-select" aria-label="Default select example" name="martial-status" id="marr-type" reqiured>
                                                    <option disabled selected>اختر</option>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-6 col-xl-5 up18 d-none">
                                                ...
                                                <select class="form-select" aria-label="Default select example" name="martial-status" id="up18">
                                                    <option disabled selected>اختر</option>
                                                    <option value="0">0</option>
                                                    <option value="1">1</option>
                                                    <option value="2">2</option>
                                            ...
                                            <div class="col-12 col-lg-6 col-xl-4 Martyrs d-none ">
                                                ...
                                                <select class="form-select" aria-label="Default select example" id="Martyrs" name="Martyrs">
                                                    <option disabled selected>اختر</option>
                                            ...
                                            <div class="col-12 col-lg-6 col-xl-4 Martyrs-qraba d-none">
                                                ...
                                                <select class="form-select" aria-label="Default select example" id="Martyrs-qraba" name="channel" required>
                                                    <option disabled selected>اختر</option>
                                            ...
                                            <div class="col-12 col-lg-6 col-xl-4 prisoner-qraba d-none">
                                                ...
                                                <select class="form-select" aria-label="Default select example" id="prisoner-qraba" name="" required>
                                                    <option disabled selected>اختر</option>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <form class="row g-3" method="POST" action="">
                                                ...
                                                <div class="col-12 col-sm-6 col-md-3">
                                                    <label for="fourth-name" class="form-label">اللقب<span class="redStar">*</span></label>
                                                    <input type="text" class="form-control" id="fourth-name" name="fourth-name" value="<?php echo $rowm['sure_name']; ?>" />
                                                </div>

                                                <!-- user full mother name -->
                                                <div class="col-12 col-sm-6 col-md-4">
                                                    <label for="mom-first-name" class="form-label">اسم الام<span class="redStar">*</span></label>
                                                    <input type="text" class="form-control" id="mom-first-name" name="mom-first-name" value="<?php echo $rowm['mother_firstname']; ?>" />
                                                </div>
                                                <div class="col-12 col-sm-6 col-md-4">
                                                    <label for="mom-second-name" class="form-label">اسم اب الام<span class="redStar">*</span></label>
                                                    <input type="text" class="form-control" id="mom-second-name" name="mom-second-name" value="<?php echo $rowm['mother_secondname']; ?>" />
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="mom-third-name" class="form-label">اسم جد الام<span class="redStar">*</span></label>
                                                    <input type="text" class="form-control" id="mom-third-name" name="mom-third-name" value="<?php echo $rowm['mother_thirdname']; ?>" />
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <label for="nationalism" class="form-label">القومية<span class="redStar">*</span></label>
                                                    <select class="form-select" aria-label="Default select example" name="nationalism" value="" id="nationalism">
                                                        <option value="<?php echo $rowm['nationalism']; ?>"><?php echo $rowm['nationalism']; ?></option>
                                                        <option value="عربي">عربي</option>
                                                        <option value="اجنبي">كردي</option>
                                                        <option value="تركماني">تركماني</option>
                                                    </select>
                                                ...
                                                <div class="col-md-3">
                                                    <label for="religion" class="form-label">الديانة<span class="redStar">*</span></label>
                                                    <select class="form-select" aria-label="Default select example" name="religion" value="<?php echo $rowm['religion']; ?>" id="religion">
                                                        <option disabled selected>اختر</option>
                                                        <option value="مسلم">مسلم</option>
                                                        <option value="مسيحي">مسيحي</option>
                                                        <option value="يزيدي">يزيدي</option>
                                                ...
                                                <div class="col-md-3">
                                                    <label for="sex" class="form-label">الجنس<span class="redStar">*</span></label>
                                                    <select class="form-select" aria-label="Default select example" name="gender" value="" id="sex">
                                                ...
                                                <div class="col-6 col-lg-3">
                                                    <label for="birth-place" class="form-label">محل الولادة<span class="redStar">*</span></label>
                                                    <input type="text" class="form-control" id="birth-place" name="birth-place" value="<?php echo $rowm['place_birth']; ?>" />
                                                </div>

                                                <div class="col-6 col-lg-3">
                                                    <label for="phone-number" class="form-label">رقم الهاتف<span class="redStar">*</span></label>
                                                    <input type="number" class="form-control" id="phone-number" name="phone-number" placeholder="<?php echo $rowm['phone_number']; ?>" readonly />
                                                </div>
                                                <?php
                                                ...
                                                ?>
                                                    ...
                                                    <div class="col-12 col-md-6 col-lg-4 div1 ">
                                                        ...
                                                        <select class="form-select" aria-label="Default select example" id="id-province1" name="id-province1">
                                                            <option disabled selected>اختر</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-12 col-md-6 col-lg-4 div2 ">
                                                        <label for="id-number" class="form-label">رقم البطاقة الوطنية<span class="redStar">*</span></label>
                                                        <input type="number" class="form-control" id="id-number" name="id-number" value="<?php echo $rowm['nationality_card_number']; ?>" />
                                                    </div>
                                                ...
                                                ?>
                                                    ...
                                                    <div class="col-12 col-md-6 col-xl-4 div3 d-none">
                                                        <label for="id-province2" class="form-label">المحافظة التي صدرت منها هوية الاحوال
                                                            المدنية<span class="redStar">*</span></label>
                                                        <select class="form-select" aria-label="Default select example" id="id-province2" name="id-province2">
                                                            <option disabled selected>اختر</option>
                                                        </select>
                                                    </div>
