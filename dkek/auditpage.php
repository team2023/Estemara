...
<div class="d-flex flex-column">
    <p>
      ...
      عدد الاطفال الاصغر من  18 سنة :   <?php echo $namemary2 ;?>
                    ...
                    <input type="number" class="w-25 d-none" name="ch" value="<?php echo $namemary2 ;?>" id="notd18"  >
</div>
<div class="d-flex flex-column">
                    <p>
                    <?php 
...
<input type="checkbox" name="" id="cu18" onchange="handleCheckboxChange('cu18','notu18')">
 عدد الاطفال الاكبر من  18 سنة :   <?php echo $namemary3 ;?>
                     ...
                     <input type="number" class="w-25 d-none" name="ch2" value="<?php echo $namemary3 ;?>" id="notu18" >
</div>
                </div>
...
<?php
  ...
  <script>
    function handleCheckboxChange(check,input) {
      ...
      if (checkbox.checked) {
          input.classList.remove("d-none"); // Remove the class
         input.setAttribute('reqiured','');
        
      } else {
        input.classList.add("d-none"); // Add the class
        input.removeAttribute('reqiured','');
      }
    }
  </script> 
</body>
